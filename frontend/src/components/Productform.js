    ...
    <div className='Productpagecontainer'>
      ...
      <form id='userform' onSubmit={saveProduct} className='productform'>
       <div className='productdatacontainer'><label >Poduct Image:
        ...
        <p className='suppoetedfiles'>Supported Files jpg , jpeg , png</p>
         
          <input type='file'  ref={inputFile} name='image' id="file-input"  accept="image/jpg,image/jpeg,image/png" onChange={(e)=>handleImageinputs(e)}/>
...
<p className='suppoetedfiles'>no image set for this product</p>
       ...
       <div className='productdatacontainer'> <div> <label>Product Price:</label></div><input  onWheel={(e) => e.target.blur()} type='number' name='price'value={product?.price} placeholder='Product price' onChange={(e)=>(handleinputs(e))}/></div>
