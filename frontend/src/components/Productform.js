...
<p>no image set for this product</p>
       ...
       <div  className='productdatacontainer'> <div><label>Product Quantity :</label></div><input onWheel={(e) => e.target.blur()}   type='number' name='quantity'value={product?.quantity.trim()} placeholder=' Product quantity' onChange={(e)=>(handleinputs(e))}/></div>
